...
import java.util.functions.IntToDoubleFunction;
import java.util.functions.IntToLongFunction;
...
//    }
     ...
     */
    public static  void sort<T>(T[] a, Comparator<? super T> c) {
        if (LegacyMergeSort.userRequested)
            legacyMergeSort(a, c);
        else
            TimSort.sort(a, c);
    ...
    /** To be removed in a future release. */
    private static  void legacyMergeSort<T>(T[] a, Comparator<? super T> c) {
        T[] aux = a.clone();
        if (c==null)
            mergeSort(aux, a, 0, a.length, 0);
        else
    ...
    /** To be removed in a future release. */
    private static  void legacyMergeSort<T>(T[] a, int fromIndex, int toIndex,
                                            Comparator<? super T> c) {
        rangeCheck(a.length, fromIndex, toIndex);
     ...
     * @since 1.8
     */
    public static  void parallelSort<T extends Comparable<? super T>>(T[] a) {
        parallelSort(a, 0, a.length);
    }
     ...
     */
    public static 
            void parallelSort<T extends Comparable<? super T>>(T[] a, int fromIndex, int toIndex) {
        rangeCheck(a.length, fromIndex, toIndex);
        int nelements = toIndex - fromIndex;
     ...
     * @since 1.8
     */
    public static  void parallelSort<T>(T[] a, Comparator<? super T> c) {
     ...
     * @since 1.8
     */
    public static  void parallelSort<T>(T[] a, int fromIndex, int toIndex,
                                        Comparator<? super T> c) {
        rangeCheck(a.length, fromIndex, toIndex);
        int nelements = toIndex - fromIndex;
        Class<?> tc = a.getClass().getComponentType();
     ...
     */
    public static  int binarySearch<T>(T[] a, T key, Comparator<? super T> c) {
     ...
     * @since 1.6
     */
    public static  T[] copyOf<T,U>(U[] original, int newLength, Class<? extends T[]> newType) {
        @SuppressWarnings("unchecked")
     ...
     * @since 1.6
     */
    public static  T[] copyOfRange<T,U>(U[] original, int from, int to, Class<? extends T[]> newType) {
     ...
     * @since 1.8
     */
    public static  void setAll<T>(T[] array, IntFunction<? extends T> generator) {
     ...
     * @since 1.8
     */
    public static  void parallelSetAll<T>(T[] array, IntFunction<? extends T> generator) {
        Objects.requireNonNull(generator);
